...
let userinfo1 = user.name + '\n';

document.cookie = document.cookie + userinfo1; // user1
};
...
let user = new User("user2");

let userinfo2 = user.name + '\n';

document.cookie = document.cookie + userinfo2; // user2
};
